...
right join tutorial on tutorial.tutor_staff_id_fk = user_staff.id");
?>
...
<!--title-->        
        ...
        <div class="container">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="allocate_tutor_dc.php">Allocate Tutor</a></li>
            </ul>
        </div>
        <!--tab end--> 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row2['unavailable']; ?></td>
                             <td><a href="dc_edit_allocate_tutor.php?staff_id=<?php echo $row2['staff_id']?>&tutorial_id=<?php echo $row2['tutorial_code']?>">Change</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
