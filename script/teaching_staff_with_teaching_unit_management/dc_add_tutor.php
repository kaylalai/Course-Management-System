<!--this page fou dc only .back end event to make change the tutor in each tutorial by using the get method tutorial id-->
...
header ('location:allocate_tutor_dc.php');
