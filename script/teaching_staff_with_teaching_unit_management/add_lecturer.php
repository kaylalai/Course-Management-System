<!--this page fou uc only . make change of the lecturer , swap a new one one in the database , update the role and change the unit detail coloum lecturer( the related unit)-->
<?php
session_start(); 
include('../db_conn.php'); 
...
header ('location:allocate_lecturer.php');
